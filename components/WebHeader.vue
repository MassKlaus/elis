<template>
    <header class="bg-transparent text-white absolute z-10 w-full">
        <nav class="container mx-auto flex justify-between items-center p-4">
            <div class="text-xl font-bold">Will Reps</div>
            ...
            <div class="flex cursor-pointer md:hidden flex-col items-center gap-[4px]" @click="x => toggleSideBar()">
    ...
    <div class="h-screen fixed md:hidden bg-white z-50 right-0 p-4 w-[300px] translate-x-0 transition-transform duration-250"
        ...
        <div class="flex justify-between items-center">
            ...
            <div class="cursor-pointer relative mr-3" @click="x => toggleSideBar()">
